...
Next, we will visualize this clustering in the context of the meta data. Make sure you have the SNP tree that you generated (or can be downloaded here [core\_snps.newick](files/core_snps.newick)) on your own computer.
