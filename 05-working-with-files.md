...
don't have permission to carry out the ability encoded by that space (this is the space where `x` or executable ability is stored, more about this in [a different lesson](https://www.datacarpentry.org/shell-genomics/05-writing-scripts/)).
...
```output
rm: remove write-protected regular file <U+2018>SRR098026-backup.fastq<U+2019>? 
```
